...
export function SubTitle(props: {
  ...
  return (
    <div className='dark:text-dark post-card-sub-title divide-x divide-gray-400 text-center text-xs text-gray-400 md:text-sm'>
      ...
      {props.type != 'about' && (
        <span className='dark:group group inline-flex cursor-pointer items-center px-2'>
          <span className={iconClass}>
            <svg
              viewBox='0 0 1024 1024'
              version='1.1'
          ...
          <Link
            ...
            <div className='dark:group-hover:text-dark-hover cursor-pointer hover:font-medium group-hover:text-gray-900 '>{`${props.catelog}`}</div>
          </Link>
        </span>
      )}
      <span className='inline-flex items-center px-2'>
